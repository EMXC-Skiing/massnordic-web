...
This document serves as the primary reference on how eligibility, MA Nordic Points, the MA Ranking List (MRL), and team selection operate. It is intended to be more detailed and comprehensive than the [guide on how to qualify]({% link qualification/index.md %}) and [guide for coaches]({% link qualification/coaches-guide.md %}) .
